  ...
  return (
    <div className='bg-[#151c25] gradient-bg-artworks'>
      <div className='w-4/5 py-10 mx-auto'>
        ...
        text-gradient'>Latest Artworks</h4>
        <div className='grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gaps-6 md:gaps-3 py-2.5'>
          {Array(4)
          .fill()
          .map((nft,i)=>(
          <Card key={i} nft={i + 1}/>) )}
...
const Card =({nft}) => (
  <div className="w-full shadow-xl shadow-black rounded-md overflow-hidden bg-gray-800 my-2 p-3">
    ...
    <p className="text-grey-400 text-sm my-1">
      Lorem ipsum dolor sit amet consectetur adipisicing elit. Eveniet impedit esse doloribus dolores iusto aperiam, nulla numquam, eligendi necessitatibus assumenda autem adipisci, fuga pariatur labore ipsam aspernatur officiis quaerat dolore.
       </p>
       <div className="flex justify-between items-center mt-3 text-white">
          ...
          <button className="shadow-lg shadow-black text-sm bg-[#e32970] hover:bg-#bd-[#bd255f] rounded-full px-1.5 py-1  "
